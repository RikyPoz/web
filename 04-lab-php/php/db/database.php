...
class DatabaseHelper{
    ...
    public function getAuthors($n = -1){
        $stmt = $this->db->prepare("SELECT username, nome, GROUP_CONCAT(DISTINCT nomecategoria) as argomenti 
    ...
    public function getPostsbyId($n){
        $stmt = $this->db->prepare("SELECT idarticolo, titoloarticolo, imgarticolo, dataarticolo, anteprimaarticolo, nome  
        FROM articolo, autore WHERE autore=idautore AND idarticolo = $n");
